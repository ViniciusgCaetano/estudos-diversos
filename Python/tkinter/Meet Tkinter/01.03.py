...
root = Tk()
root.title('Este é o TopLevel - 1')
...
bitmap = BitmapImage(file="D:/Vinicius/Programacao/estudos-diversos/Python/tkinter/Meet Tkinter/contents/gir.xbm")
...
photo = PhotoImage(file='D:/Vinicius/Programacao/estudos-diversos/Python/tkinter/Meet Tkinter/contents/dance.gif')
...
fhandle = open('D:/Vinicius/Programacao/estudos-diversos/Python/tkinter/Meet Tkinter/contents/textcontent.txt')
lines = fhandle.read()
fhandle.close()
